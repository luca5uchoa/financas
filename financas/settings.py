...
SECRET_KEY = 'django-insecure-*^hh&n2vu%jxfa1_g$rssm(fizg7m!0ztk8cktkyy5q*&rlo#g'
...
AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',  # Usando o backend de autenticação padrão
]
